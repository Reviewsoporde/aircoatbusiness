...
All pages share one visual design system: consistent hero layout, CTA styling, clear H1/H2 hierarchy, short readable sections, commercial project imagery, related-page cards, business-focused lead form, visible FAQ accordions where relevant.

- Parent pages give an **overview**; child pages focus on **one** property, system, or service intent.
...
| Page type | Primary CTA (NL) |
|---|---|
| Property page | Vraag een offerte aan |
| Installation page | Plan een adviesgesprek |
| System page | Vraag systeemadvies aan |
| Maintenance page | Onderhoud aanvragen |
| Maintenance contract | Vraag contractadvies aan |
| Repair page | Reparatie aanvragen |
...
Max **seven** main content sections per service page:

```
1. Hero
2. Service Overview & Audience
3. Business Need & Benefits
4. Solution Scope & Technical Fit
5. Process
6. Projects, Reviews & Trust
7. Lead Form, Related Services & FAQ
```
...
| Page | Template |
|---|---|
| `/zakelijke-airconditioning/`, `/installatie/`, `/onderhoud/` | **A. Parent Category** |
| `/airco-kantoor/`, `/airco-bedrijfspand/`, `/airco-winkel/`, `/airco-showroom/` | **B. Property-Specific** |
| `/zakelijke-airco-installatie/` | **C. Commercial Installation** |
| `/cassette-airco-bedrijf/`, `/kanaal-airco-bedrijf/`, `/wandmodel-airco-bedrijf/` | **D. System** |
| `/airco-onderhoud-zakelijk/` | **E. Maintenance** |
| `/airco-onderhoudscontract-zakelijk/` | **F. Maintenance Contract** |
| `/airco-reparatie-zakelijk/` | **G. Repair** |

**A. Parent Category:** Hero → Category Overview → Child-Page Cards → Business Need & Category Benefits → Process → Projects & Reviews → Lead Form & FAQ. Child cards replace the technical-scope section; don't duplicate child-page content.

**B. Property-Specific:** Hero → Property Overview & Audience → Climate Challenges & Benefits (uneven temperatures, large open spaces, customer comfort, productivity, heat from lighting/equipment, climate zones) → Recommended Solutions & Service Scope → Process → Property-Specific Projects & Reviews → Lead Form (property preselected), Related Systems & FAQ.
...
**F. Maintenance Contract:** Hero → Contract Overview & Suitable Businesses → Business Continuity Benefits → Contract Coverage & Scope → Contract Setup Process → Reviews & Trust → Lead Form, Related Maintenance Services & FAQ. Focus: recurring service, preventive planning, predictability, reduced disruption, long-term performance.

**G. Repair:** Hero **with immediate contact CTA** → Common Problems & Faults → Inspection & Repair Scope → Repair Process → Reviews & Trust → Repair Form / Direct Contact → Maintenance Recommendation, Related Services & FAQ. Prioritize speed and contact; CTA appears in hero, after process, and in conversion section.
...
| Message / project details | No |

- **Property type options:** Office · Commercial building · Retail store · Showroom · Other
- **Service options:** Business Air Conditioning · Commercial AC Installation · Maintenance · Repairs · Maintenance Contract · System Advice · Project Consultation · Not sure yet
- Submit button: **"Offerte aanvragen"**
- The form must record the **source page** and **selected service** for CRM tracking; service/property preselected based on the page.

## 6. Projects Page

Hero → Project Filters → Project Grid → Featured Project → Service Links → CTA.
Filters: Office · Commercial building · Retail · Showroom · Cassette · Ducted · Wall-mounted.
Each card: project type, location, system, short summary, images, link to relevant service page.

## 7. Our Process Page

Hero → Process Overview → Step 1 Consultation → Step 2 Site Analysis & Advice → Step 3 Proposal & Planning → Step 4 Installation → Step 5 Maintenance & Support → FAQ → Contact CTA. Practical: what a commercial customer can expect after making contact.

## 8. Contact Page

Hero → Contact Options → Business Inquiry Form → Service Area → Business Details → FAQ.
Contact options: phone, email, form, optional WhatsApp, address, opening hours.
Form service options: Business Air Conditioning · Installation · Maintenance · Repairs · Maintenance Contract · Project Consultation.

## 9. Design Consistency Rules

Keep consistent across all pages: hero layout, heading hierarchy, section spacing, CTA styling, card design, process design, form layout, FAQ accordion, related-page cards. Content and section depth vary; the design must remain recognizable.
